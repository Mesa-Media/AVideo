...
<body>
    <iframe frameborder="0" marginheight="0" marginwidth="0" width="100%" height="100%" scrolling="auto" src="<?php echo getURL('view\index_loading.html'); ?>" id="mainIframe" name="mainIframe"></iframe>
